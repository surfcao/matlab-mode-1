...
\\{matlab-mode-map}"
  ...
  (set (make-local-variable 'page-delimiter) "^\\(\f\\|%%\\(\\s-\\|\n\\)\\)")
  (set (make-local-variable 'comment-column) matlab-comment-column)
  (set (make-local-variable 'comment-indent-function) 'matlab-comment-indent)
  (set (make-local-variable 'add-log-current-defun-function) 'matlab-current-defun)
  (set (make-local-variable 'fill-column) default-fill-column)
  (set (make-local-variable 'auto-fill-function) 'matlab-auto-fill)
  (set (make-local-variable 'normal-auto-fill-function) 'matlab-auto-fill)
  (make-local-variable 'fill-prefix)
  (set (make-local-variable 'imenu-generic-expression) matlab-imenu-generic-expression)
  ...
  ;; Tempo tags
  (set (make-local-variable 'tempo-local-tags) (append matlab-tempo-tags tempo-local-tags))
  ...
  (let ((msbn (matlab-shell-buffer-barf-not-running))
    ...
    (save-excursion
      ...
      (save-mark-and-excursion
        (goto-char pos)
        (beginning-of-line)
        (setq str (buffer-substring-no-properties (save-mark-and-excursion
                                                    (goto-char pos)
                                                    (beginning-of-line)
                                                    (forward-line 1)
                                                    (point))
